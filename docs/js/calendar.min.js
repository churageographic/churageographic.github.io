...
function getJsonData(c,b){return new Promise((d,a)=>{const g=b.substr(0,2),f=b.substr(2);$.get(`https://${location.host}/data/${g}/${f}/${c}.json`,function(e){e.warn||e.error?a(e):d(e)},"json").fail(function(e){toastr.error(`\u300c ${$("#area option:selected").text()}\u306e\u60c5\u5831\u3092\u53d6\u5f97\u3067\u304d\u307e\u305b\u3093\u3067\u3057\u305f`)})})}
